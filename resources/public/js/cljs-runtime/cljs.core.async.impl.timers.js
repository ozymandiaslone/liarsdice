...
var i_12460 = (self__.level + (1));
while(true){
if((i_12460 <= (new_level + (1)))){
(update[i_12460] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_12463 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_12463[i]));
} else {
x__$2.forward.push((((i < links_12463.length))?(links_12463[i]):null));
}

if((i < links_12463.length)){
(links_12463[i] = x__$2);
} else {
links_12463.push(x__$2);
}
...
var i_12470 = (0);
while(true){
if((i_12470 <= self__.level)){
var links_12472 = (update[i_12470]).forward;
if((x__$1 === (((i_12470 < links_12472.length))?(links_12472[i_12470]):null))){
(links_12472[i_12470] = (x__$1.forward[i_12470]));

var G__12474 = (i_12470 + (1));
i_12470 = G__12474;
continue;
} else {
var G__12475 = (i_12470 + (1));
i_12470 = G__12475;
continue;
}
} else {
...
var G__12485 = nx;
var G__12486 = (level__$1 - (1));
x = G__12485;
level__$1 = G__12486;
continue;
} else {
var G__12487 = x;
var G__12488 = (level__$1 - (1));
x = G__12487;
level__$1 = G__12488;
continue;
}
