...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_17927 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_17927(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_17928 = (function (runtime,key,spec){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_17928(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_17939 = (function (runtime,key){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_17939(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_17941 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_17941(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_17958 = (function (runtime,input,callback){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_17958(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_17959 = (function (runtime,code,success,fail){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_17959(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__17914,callback){
var map__17918 = p__17914;
var map__17918__$1 = cljs.core.__destructure_map(map__17918);
var input = map__17918__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17918__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17918__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
