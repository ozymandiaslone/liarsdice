...
var cljs$tools$reader$reader_types$Reader$peek_char$dyn_22106 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_22106(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22112 = (function (reader,ch){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22112(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22116 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22116(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22117 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22117(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22125 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22125(reader);
}
});
...
var G__22154 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__22155 = s.append(c);
c = G__22154;
s = G__22155;
continue;
}
